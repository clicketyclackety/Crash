...
namespace Crash
{
    ...
    public class CrashClient
    {
        ...
        public CrashClient(string userName, Uri url)
        {
            ...
            _connection.On<string, ISpeck>("Add", (user, speck) => OnAdd?.Invoke(user, speck));
            _connection.On<string, Guid>("Delete", (user, id) => OnDelete?.Invoke(user, id));
            _connection.On<string, Guid, ISpeck>("Update", (user, id, speck) => OnUpdate?.Invoke(user, id, speck));
            ...
            _connection.On<ISpeck[]>("Initialize", (specks) => OnInitialize?.Invoke(specks));
        ...
        /// <returns></returns>
        public async Task Update(Guid id, ISpeck speck)
        {
        ...
        public async Task Add(ISpeck speck)
        {
